(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('jquery'), require('backbone'), require('backbone.marionette')) :
  typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'jquery', 'backbone', 'backbone.marionette'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AutoComplete = {}, global._, global.$, global.Backbone, global.Marionette));
})(this, (function (exports, _, $, Backbone, Marionette) { 'use strict';
